...
const ClassCard: React.FC<ClassCardProps> = ({
  ...
  <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
    <div className="relative h-64 bg-linear-to-b from-transparent to-black/30">
      ...
      <div className="bg-linear-to-t from-black/80 to-transparent p-6 absolute bottom-0 w-full">
